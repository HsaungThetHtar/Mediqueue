...
// SVG paths for icons
const svgPaths = {
  p2e1c0dd8: "M20 20c0-5.523-4.477-10-10-10S0 14.477 0 20s4.477 10 10 10 10-4.477 10-10z", // Placeholder, replace with actual paths if needed
  p2e952fc0: "M10 10c0-2.761-2.239-5-5-5S0 7.239 0 10s2.239 5 5 5 5-2.239 5-5z",
  p2e029080: "M5 5c0-1.105-.895-2-2-2S1 3.895 1 5s.895 2 2 2 2-.895 2-2z",
  p38955500: "M10 10c0-2.761-2.239-5-5-5S0 7.239 0 10s2.239 5 5 5 5-2.239 5-5z",
  p3bc71800: "M5 5c0-1.105-.895-2-2-2S1 3.895 1 5s.895 2 2 2 2-.895 2-2z",
  p392e0e40: "M10 10c0-2.761-2.239-5-5-5S0 7.239 0 10s2.239 5 5 5 5-2.239 5-5z",
  pacb6380: "M10 10c0-2.761-2.239-5-5-5S0 7.239 0 10s2.239 5 5 5 5-2.239 5-5z",
  p9853340: "M10 10c0-2.761-2.239-5-5-5S0 7.239 0 10s2.239 5 5 5 5-2.239 5-5z",
  p2daa8800: "M5 5c0-1.105-.895-2-2-2S1 3.895 1 5s.895 2 2 2 2-.895 2-2z"
};
...
export default function SignUp() {
  ...
  const handleCreateAccount = async (e) => {
    ...
    try {
      // Call backend API for patient registration
        ...
        <div className="bg-white rounded-2xl shadow-[0px_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)] border border-[#f3f4f6] p-10 mb-6">
          ...
          <form onSubmit={handleCreateAccount} className="space-y-4">
            ...
            <div className="text-center mt-4">
              ...
              <Link to="/login" className="text-sm text-[#1e88e5] font-medium hover:underline">Log In</Link>
            </div>
          </form>
        </div>
